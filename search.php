...
<div class="container">
    <div class="row">
        ...
        if (isset($_POST['name']) && is_string($_POST['name'])) {
            echo '<h1 class="text-center">Show Items By Search Name</h1>';
            $name = $_POST['name'];
            $nameItems = getAllFrom("*", "items", "where Name like '%$name%'", "AND Approve = 1", "ItemID");
            ...
            $theMsg = '<div class="alert alert-danger">You Must Enter Correct Name of Item</div>';
